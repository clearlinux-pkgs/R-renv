...
Source0  : https://cran.r-project.org/src/contrib/renv_1.0.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709234856
...
/usr/lib64/R/library/renv/repos/src/contrib/renv_1.0.5.tar.gz
