...
Source0  : https://cran.r-project.org/src/contrib/renv_1.0.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712851725
...
/usr/lib64/R/library/renv/repos/src/contrib/renv_1.0.6.tar.gz
